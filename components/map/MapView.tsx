...
export default function MapView() {
  ...
  const [rainViewerVisible, setRainViewerVisible] = useState(false);
  const [tfrVisible, setTfrVisible] = useState(true);
  const [suaVisible, setSuaVisible] = useState(false);
  ...
  const [terrainOutlineVisible, setTerrainOutlineVisible] = useState(false);
  const [nexradVisible, setNexradVisible] = useState(false);
  const [noaaInfraredVisible, setNoaaInfraredVisible] = useState(false);
